//only index and capacity is a int types others considered is X  placeHolder stayed
#include <bits/stdc++.h>
#include <iostream>
using namespace std;
...
public:
     ...
     void viewElement(int index, X &data) //& cause it store reference of index no
     {
          if (index >= 0 && index <= s->capacity - 1)
          {
...
{
     int data;
     Arraylist <int > list1(4);         // constructor single argument for capacity of arrray
     //using angular bracket <int > x is a int type 
